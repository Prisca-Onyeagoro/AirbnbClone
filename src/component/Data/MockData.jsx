...
export const locationsTab = [
  { id: 1, label: 'Design', icon: <ViewQuilt size={24} /> },
  { id: 2, label: 'Arctic', icon: <AcUnit size={24} /> },
  { id: 3, label: 'Shared Homes', icon: <Roofing size={24} /> },
  { id: 4, label: 'LakeFront', icon: <Water size={24} /> },
  { id: 5, label: 'National Parks', icon: <AttractionsIcon size={24} /> },
  { id: 6, label: 'Bed & Breakfast ', icon: <FreeBreakfastIcon size={24} /> },
  { id: 7, label: 'OMG!', icon: <CabinIcon size={24} /> },
  { id: 8, label: 'Camping', icon: <RocketLaunchIcon size={24} /> },
  { id: 9, label: 'A-frames', icon: <FilterFramesIcon size={24} /> },
  { id: 10, label: 'Domes', icon: <BalconyIcon size={24} /> },
  { id: 11, label: 'Tiny Homes', icon: <BungalowIcon size={24} /> },
  { id: 12, label: 'Treehouses', icon: <NaturePeopleIcon size={24} /> },
  { id: 13, label: 'Surfing', icon: <SurfingIcon size={24} /> },
  { id: 14, label: 'CountrySide', icon: <LandscapeIcon size={24} /> },
  { id: 15, label: 'Caves', icon: <FilterHdrIcon size={24} /> },
  { id: 16, label: 'Golfing', icon: <GolfCourseIcon size={24} /> },
  { id: 17, label: 'Cabins', icon: <PublicIcon size={24} /> },
  { id: 18, label: 'Earth Homes', icon: <ForestIcon size={24} /> },
  { id: 19, label: 'Tropical', icon: <ForestIcon size={24} /> },
  { id: 20, label: 'Amazing Pools', icon: <PoolIcon size={24} /> },
];
